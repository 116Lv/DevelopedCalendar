...
public class CalendarController {
    ...
    public ResponseEntity<String> loginUSer(@RequestBody UserRequestDto dto, HttpServletRequest request) {
    ...
    public ResponseEntity<String> checkSession(HttpServletRequest request) {
        ...
        if (session == null) {
            return ResponseEntity.ok("세션이 아예 없습니다.");
        }
        ...
        return ResponseEntity.ok("현재 로그인된 유저: " + userEmail);
    }
